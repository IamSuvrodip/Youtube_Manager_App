...
# mongodb+srv://youtubepy:<youtubepy>@cluster0.pjxc15s.mongodb.net/ytmanager

from pymongo import MongoClient
from bson import ObjectId

client = MongoClient("mongodb+srv://youtubepy:<youtubepy>@cluster0.pjxc15s.mongodb.net/ytmanager", tlsAllowInvalidCertificates=True)
